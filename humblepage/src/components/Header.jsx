            ...
            <div>
                ...
                <div className='container mt-3'>
                    {this.state.isDesktop ? (
                        <ul className="nav">
                            <li className='nav-item'><Link to='/' className='nav-link'><img src={logo} alt='header-logo' className='logo mb-2 mr-2'></img> <span className='brand-title mr-3'>humblepage</span></Link></li>
