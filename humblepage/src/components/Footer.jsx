                    ...
                    {this.state.isDesktop ? (
                        <div className='row'>
                            <div className='col-lg-3 mt-4'>
                                <h4 className='footer-title'>humblepage</h4>
                            </div>
                            <div className='col-lg-3 mt-4'>
                                <h6 className='footer-title text-muted mb-3'>EXPLORE</h6>
                                <div><Link to='/about' className='white-color'>About</Link></div>
                                <div><Link to='/services' className='white-color'>Services</Link></div>
                        ...
                        <div className='col-lg-12 text-center'>
                            <h4 className='footer-title mb-5'>humblepage</h4>
                            <h6 className='footer-title text-muted mb-3'>GET IN TOUCH</h6>
                            <div><a href='mailto:john@humblepage.com' className='white-color'>john@humblepage.com</a></div>
                            <div><a href='tel:0894518912' className='white-color'>(089) 451 8912</a></div>
                        </div>
