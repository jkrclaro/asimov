...
def email_confirmation(user: db.Model) -> None:
...
def email_change_email_success(user: db.Model, old_email: str) -> None:
...
def email_reset_success(user: db.Model):
...
def email_change_password_success(user: db.Model) -> None:
...
def email_change_email(user: db.Model, new_email: str):
