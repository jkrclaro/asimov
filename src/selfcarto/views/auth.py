...
from src.selfcarto.models.auth import User
from src.selfcarto.models.merchant import Merchant
from src.selfcarto.forms import (
    SignupForm,
    LoginForm,
    ForgotPasswordForm,
    ResetPasswordForm,
...
from src.selfcarto.helpers.email import (
    email_confirmation,
    email_change_email_success,
    email_reset,
    email_reset_success
)
from src.selfcarto.helpers.recaptcha import validate_recaptcha
...
def reset():
    ...
    if form.validate_on_submit():
        ...
        email_reset_success()
        login_user(user)
        flash('Successfully changed your Selfcarto password', 'success')
        return redirect(url_for('merchant.index'))
