...
from src.healthstruct.models.merchant import Merchant
from src.healthstruct.forms import (
    SignupForm,
    LoginForm,
    ForgotPasswordForm,
    ResetPasswordForm,
...
from src.healthstruct.helpers.recaptcha import validate_recaptcha
...
def reset():
    ...
    if form.validate_on_submit():
        ...
        email_reset_success()
        login_user(user)
        flash('Successfully changed your Healthstruct password', 'success')
        return redirect(url_for('merchant.index'))
