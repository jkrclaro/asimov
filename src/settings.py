...
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = f'Spidxr <{EMAIL_HOST_USER}>'
...
if DEBUG:
    ALLOWED_HOSTS = ('spidxr.localhost',)
    DATABASES = {
        'default': {
