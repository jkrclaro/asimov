...
LOGIN_URL = '/login'
LOGIN_REDIRECT_URL = '/'
AUTH_USER_MODEL = 'channelry.User'
...
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = f'Channelry <{EMAIL_HOST_USER}>'
...
if DEBUG:
    ALLOWED_HOSTS = ('channelry.localhost',)
    DATABASES = {
        'default': {
...
AUTHENTICATION_BACKENDS = (
    ...
    'src.channelry.backends.EmailAuth',
