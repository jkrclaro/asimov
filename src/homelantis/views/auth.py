...
from src.homelantis.models.customer import Customer
from src.homelantis.models.merchant import Merchant
from src.homelantis.forms import (
    SignupForm,
    LoginForm,
    ForgotPasswordForm,
    ResetPasswordForm,
...
from src.homelantis.helpers.email import (
    email_confirmation,
    email_change_email_success,
    email_reset,
    email_reset_success
)
from src.homelantis.helpers.recaptcha import validate_recaptcha
...
def reset():
    ...
    if form.validate_on_submit():
        ...
        email_reset_success()
        login_user(user)
        flash('Successfully changed your Homelantis password', 'success')
        return redirect(url_for('merchant.index'))
