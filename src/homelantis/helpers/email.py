...
def email_confirmation() -> None:
    ...
    subject = 'Confirm your Homelantis email address!'
...
def email_change_email_success(old_email: str) -> None:
    ...
    subject = 'Your Homelantis email address has changed'
    name = current_user.customer.name
...
def email_reset() -> None:
    ...
    subject = 'Reset your Homelantis password'
    data = {'email': email}
    context = {
        'endpoint': endpoint,
        'data': data
...
def email_reset_success() -> None:
    ...
    subject = 'Your Homelantis password has been changed'
...
def email_change_email(new_email: str) -> None:
    ...
    subject = 'Confirm your new Homelantis email address!'
