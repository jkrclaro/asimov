...
def email_confirmation() -> None:
    ...
    subject = 'Confirm your Hapload email address!'
...
def email_change_email_success(old_email: str) -> None:
    ...
    subject = 'Your Hapload email address has changed'
    name = current_user.profile.name
...
def email_reset() -> None:
    ...
    subject = 'Reset your Hapload password'
    data = {'email': email}
    context = {
        'endpoint': endpoint,
        'data': data
...
def email_reset_success() -> None:
    ...
    subject = 'Your Hapload password has been changed'
...
def email_change_email(new_email: str) -> None:
    ...
    subject = 'Confirm your new Hapload email address!'
