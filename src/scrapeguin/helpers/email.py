...
def email_confirmation() -> None:
    ...
    subject = 'Confirm your Scrapeguin email address!'
...
def email_change_email_success(old_email: str) -> None:
    ...
    subject = 'Your Scrapeguin email address has changed'
    name = current_user.profile.name
...
def email_reset() -> None:
    ...
    subject = 'Reset your Scrapeguin password'
    data = {'email': email}
    context = {
        'endpoint': endpoint,
        'data': data
...
def email_reset_success() -> None:
    ...
    subject = 'Your Scrapeguin password has been changed'
...
def email_change_email(new_email: str) -> None:
    ...
    subject = 'Confirm your new Scrapeguin email address!'
