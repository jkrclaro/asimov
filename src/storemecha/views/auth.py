...
from src.storemecha.models.auth import User
from src.storemecha.models.merchant import Merchant
from src.storemecha.forms import (
    SignupForm,
    LoginForm,
    ForgotPasswordForm,
    ResetPasswordForm,
...
from src.storemecha.helpers.email import (
    email_confirmation,
    email_change_email_success,
    email_reset,
    email_reset_success
)
from src.storemecha.helpers.recaptcha import validate_recaptcha
...
def reset():
    ...
    if form.validate_on_submit():
        ...
        email_reset_success()
        login_user(user)
        flash('Successfully changed your Storemecha password', 'success')
        return redirect(url_for('merchant.index'))
