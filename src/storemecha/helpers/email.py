...
def email_confirmation() -> None:
    ...
    subject = 'Confirm your Storemecha email address!'
...
def email_change_email_success(old_email: str) -> None:
    ...
    subject = 'Your Storemecha email address has changed'
    name = current_user.customer.name
...
def email_reset() -> None:
    ...
    subject = 'Reset your Storemecha password'
    data = {'email': email}
    context = {
        'endpoint': endpoint,
        'data': data
...
def email_reset_success() -> None:
    ...
    subject = 'Your Storemecha password has been changed'
...
def email_change_email(new_email: str) -> None:
    ...
    subject = 'Confirm your new Storemecha email address!'
