...
from src.selfcarte.models.auth import User, Profile
from src.selfcarte.models.merchant import Merchant
from src.selfcarte.forms import (
    SignupForm,
    LoginForm,
    ForgotPasswordForm,
    ResetPasswordForm,
...
from src.selfcarte.helpers.email import (
    email_confirmation,
    email_change_email_success,
    email_reset,
    email_reset_success
)
from src.selfcarte.helpers.recaptcha import validate_recaptcha
...
def reset():
    ...
    if form.validate_on_submit():
        ...
        email_reset_success()
        login_user(user)
        flash('Successfully changed your Selfcarte password', 'success')
        return redirect(url_for('dashboard.index'))
