...
from src.oslerkit.models.customer import Customer
from src.oslerkit.models.merchant import Merchant
from src.oslerkit.forms import (
    SignupForm,
    LoginForm,
    ForgotPasswordForm,
    ResetPasswordForm,
...
from src.oslerkit.helpers.email import (
    email_confirmation,
    email_change_email_success,
    email_reset,
    email_reset_success
)
from src.oslerkit.helpers.recaptcha import validate_recaptcha
...
def reset():
    ...
    if form.validate_on_submit():
        ...
        email_reset_success()
        login_user(user)
        flash('Successfully changed your Oslerkit password', 'success')
        return redirect(url_for('merchant.index'))
