...
class Contact extends React.Component {
    ...
    componentDidMount() {
        document.title = 'Healthy Stamp - Contact';
                            ...
                            <div className='row'>
                                <div className='col-lg-6'>
                                    ...
                                    <div>
                                        ...
                                        <p className='p-subtitle'><a href='mailto:info@healthystamp.com' className='theme-link'>info@healthystamp.com</a></p>
                                    </div>
                                ...
                                <div className='col-lg-6 mb-5'>
                                    ...
                                    <form action='https://formspree.io/info@healthystamp.com' method='POST'>
                                        ...
                                        <input type="hidden" name="_subject" value="Healthy Stamp Contact" />
                                        <input type="hidden" name="_next" value="https://healthystamp.com" />
                                        <input type='submit' className='btn btn-healthystamp-alternative' value='Send'></input>
                                    </form>
                                </div>
                            </div>
                        </div>
