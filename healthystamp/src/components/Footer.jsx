                        ...
                        <div className='col-lg-12'>
                            <div className='row'>
                                ...
                                <div className='col-lg-3 mt-3'>
                                    ...
                                    <div><a href='https://www.facebook.com/Minimalist-View-1978362455803628' rel='nofollow' className={`${theme}-text`}>Facebook</a></div>
                                    <div><a href='https://www.instagram.com/mnmlstvw' rel='nofollow' className={`${theme}-text`}>Instagram</a></div>
                                </div>
                                <div className='col-lg-3 mt-3'>
