...
ROOT_URLCONF = 'winer.urls'
WSGI_APPLICATION = 'winer.wsgi.application'
LOGIN_URL = '/login'
LOGIN_REDIRECT_URL = '/'
...
if DEBUG:
    ...
    ALLOWED_HOSTS = ('winer.jkrclaro.com',)
    ...
    STATICFILES_STORAGE = 'winer.storage.Static'
    STATICFILES_LOCATION = 'static'
    MEDIAFILES_LOCATION = 'media'
    DEFAULT_FILE_STORAGE = 'winer.storage.Media'
