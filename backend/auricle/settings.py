...
ROOT_URLCONF = 'auricle.urls'
WSGI_APPLICATION = 'auricle.wsgi.application'
LOGIN_URL = '/login'
LOGIN_REDIRECT_URL = '/'
...
if DEBUG:
    ...
    STATICFILES_STORAGE = 'auricle.storage.Static'
    STATICFILES_LOCATION = 'static'
    MEDIAFILES_LOCATION = 'media'
    DEFAULT_FILE_STORAGE = 'auricle.storage.Media'
