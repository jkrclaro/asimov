...
ROOT_URLCONF = 'eniac.urls'
WSGI_APPLICATION = 'eniac.wsgi.application'
LOGIN_URL = '/login'
LOGIN_REDIRECT_URL = '/'
...
if DEBUG:
    ...
    ALLOWED_HOSTS = ('eniac.jkrclaro.com',)
    ...
    STATICFILES_STORAGE = 'eniac.storage.Static'
    STATICFILES_LOCATION = 'static'
    MEDIAFILES_LOCATION = 'media'
    DEFAULT_FILE_STORAGE = 'eniac.storage.Media'
